...
public class GalleryScene : MonoBehaviour {
    ...
    private Sprite LastPiece;
    private bool clickEnable = false;
    private Transform EmptyBlock;
    private float puzzleMovespeed = 25f;
	// Use this for initialization
	void Start () {
        StartCoroutine(PuzzleSwap());
        GalleryAppInfo info;
        info = StaticManager.Nowappinfo.galleryinfo;
    ...
    {
        CompleteImage.sprite = Sprite.Create(test, new Rect(0, 0, test.width, test.height), new Vector2(0.5f, 0.5f));
